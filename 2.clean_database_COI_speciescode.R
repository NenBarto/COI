...
infile="/share/ScratchGeneral/nenbar/projects/Anthony/scripts/COI/leray/coi.15.fasta"
...
#plot widths
pdf("amplicon_width_leray_18S.pdf",width=6,height=4)
...
writeXStringSet(seqsS,"leray.15.taxed_speciescode.fasta",format="fasta")
